...
func _initialize() -> void:
	...
	var cases := [["ivory", "cargo-table", 61, "ivory-chip"], ["lighter", "cargo-table", 89, "old-silver-lighter"], ["ruby", "cargo-table", 90, "ruby-cufflink"], ["emerald", "ledger-cellar", 129, "emerald-brooch"], ["pearl", "ledger-cellar", 130, "pearl-necklace"], ["watch", "mirror-hall", 169, "gold-cased-watch"], ["bond", "mirror-hall", 170, "sealed-bond"], ["antique", "mirror-hall", 121, "antique-coin"], ["idol", "embers-table", 219, "obsidian-idol"], ["promissory", "embers-table", 220, "vault-promissory"], ["heat_relief", "embers-table", 161, "obsidian-idol"], ["break_even", "cargo-table", 60, ""], ["loss", "cargo-table", 0, ""], ["full_bag", "cargo-table", 61, "old-silver-lighter"], ["collateral_lost", "mirror-hall", 0, ""], ["collateral_tie", "mirror-hall", 120, ""], ["side_pot_only", "mirror-hall", 120, ""], ["legacy_award", "mirror-hall", 120, ""]]
